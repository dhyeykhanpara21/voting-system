...
router.post("/mail",authenticate, async (req, res) => {
    ...
    try{
        ...
        var transporter = nodemailer.createTransport({
            ...
            requireTLS: true,
            auth: {
                user: 'dhyey2112004@gmail.com',
                pass: 'anescsvmjocayqzd'
            }
        });
        console.log(email)
        var mail = {
            from: "dhyey2112004@gmail.com", // sender address
            to: email, // list of receivers (THIS COULD BE A DIFFERENT ADDRESS or ADDRESSES SEPARATED BY COMMAS)
            subject: `Vote Submitted for 2024 ${state}  Election`, // Subject line
      ...
      <h2>For any queries kindly contact us at dhyey2112004@gmail.com</h2>`
        };
...
router.post('/addParty', authenticate, async (req, res) => {
    try {
        ...
        fs.writeFile('../StateData.json', JSON.stringify(data1), err => {
            console.log(err);
        })
